  ...
  return (
    <div className={styles.home} style={{ ...customStyle, backgroundColor: theme.backgroundColor, color: theme.color }}>
      <div className={styles.box}>
        ...
        <h1>DEVELOPER</h1>
        <p>
        Sou desenvolvedor web e estudante de Análise e Desenvolvimento de Sistemas (EAD). Ganhei experiência ao trabalhar em projetos freelancer, onde pude aplicar e aprimorar meus conhecimentos em diversas tecnologias. Explore meu portfólio e veja como consigo transformar desafios tecnológicos em soluções inovadoras.
        </p>
      </div>
      <Skill />
    </div>
